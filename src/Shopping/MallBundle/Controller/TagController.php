...
use Shopping\MallBundle\Entity\Tag;
use Shopping\MallBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShoppingMallBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("ShoppingMallBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShoppingMallBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShoppingMallBundle:Tag:edit.html.twig")
     */
